        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstPhoneNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolClassTeachers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "SchoolClassId", "TeacherId", "Deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SchoolClassTeachers_TeacherId",
                table: "SchoolClassTeachers",
                column: "TeacherId");
